...
// import { useSession } from "@/lib/auth-client"; // Import the hook
...
//             <Link href="#" className="text-sm font-medium text-indigo-100 hover:text-white transition-colors">Deals</Link>
//           </div>

//           {/* 4. Action Icons */}
//           <div className="flex items-center gap-2 sm:gap-4">
            
//             {/* Login / User (Pill shape for emphasis) */}
//             <button className="hidden sm:flex items-center gap-2 text-indigo-100 hover:text-white hover:bg-indigo-500/50 px-3 py-2 rounded-lg transition-all">
...
//              </button>
//              <button className="flex items-center justify-center gap-2 w-full bg-indigo-600 text-white py-2.5 rounded-lg font-semibold hover:bg-indigo-700 shadow-md">
...
//               <div className="hidden sm:flex items-center gap-3 pl-2 border-l border-indigo-500 ml-2">
...
//                      {session.user.name}
//                    </span>
//                    <span className="text-[10px] text-indigo-200 uppercase tracking-wide">Member</span>
//                  </div>
//               </div>
//             ) : (
